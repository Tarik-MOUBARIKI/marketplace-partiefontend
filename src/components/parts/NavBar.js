...
<nav className="font-sans flex flex-col text-center sm:flex-row sm:text-left sm:justify-between py-4 px-6 bg-white shadow sm:items-baseline w-full">
  <div className="mb-2 sm:mb-0">
    <a href="/home" className="text-2xl no-underline text-grey-darkest hover:text-blue-dark">MarketPlace</a>
  </div>
  {/* <div className="flex ">
  <Link to='/compte' className="block text-md px-4 py-2 rounded text-red-700 ml-2 font-bold hover:text-white mt-4 hover:bg-black lg:mt-0">Sign in</Link>
  <Link to='/choiceLogin' className=" block text-md px-4  ml-2 py-2 rounded text-red-700 font-bold hover:text-white mt-4 hover:bg-black lg:mt-0">login</Link>      
  </div>
   */}
       {
      token  && <>
